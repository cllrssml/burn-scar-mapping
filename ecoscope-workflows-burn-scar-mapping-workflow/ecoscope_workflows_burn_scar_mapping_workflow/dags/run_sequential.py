...
from burn_scar_tasks import combine_burn_scar_layers as combine_burn_scar_layers
from burn_scar_tasks import compute_burn_scar_s2 as compute_burn_scar_s2
from burn_scar_tasks import count_burn_patches as count_burn_patches
from burn_scar_tasks import count_burned_area_ha as count_burned_area_ha
from burn_scar_tasks import count_high_severity_area_ha as count_high_severity_area_ha
from burn_scar_tasks import count_post_images as count_post_images
from burn_scar_tasks import count_pre_images as count_pre_images
...
from burn_scar_tasks import set_aoi_group_name as set_aoi_group_name
from burn_scar_tasks import set_overlay_group_name as set_overlay_group_name
...
def main(params: dict[str, Any], validate_params_schema: bool = True):
    ...
    burn_scar_result = (
        ...
        .validate()
        .set_task_instance_id("burn_scar_result")
        .handle_errors()
        .with_tracing()
        .skipif(
            conditions=[
        ...
        .partial(
            ...
            aoi=aoi_features,
            **(params.get("burn_scar_result") or {}),
        )
        .call()
    )
    ...
    burn_scar_layer = (
        ...
        .validate()
        .set_task_instance_id("burn_scar_layer")
        .handle_errors()
        .with_tracing()
        .skipif(
            conditions=[
        ...
        .partial(geodataframe=burn_scar_result, **(params.get("burn_scar_layer") or {}))
        .call()
    )
    ...
    combined_layers = (
        ...
        .partial(
            burn_scar_layer=burn_scar_layer,
            aoi_layer=aoi_layer,
    ...
    burn_scar_map = (
        task(draw_ecomap)
        .validate()
        .set_task_instance_id("burn_scar_map")
        .handle_errors()
        .with_tracing()
        .skipif(
            conditions=[
    ...
    burn_scar_map_url = (
        task(persist_text)
        .validate()
        .set_task_instance_id("burn_scar_map_url")
        .handle_errors()
        .with_tracing()
        .skipif(
            conditions=[
        ...
        .partial(
            ...
            text=burn_scar_map,
            **(params.get("burn_scar_map_url") or {}),
        )
        .call()
    )
    ...
    burned_area_ha = (
        ...
        .partial(geodataframe=burn_scar_result, **(params.get("burned_area_ha") or {}))
        .call()
    )
    ...
    high_severity_ha = (
        ...
        .partial(
            geodataframe=burn_scar_result, **(params.get("high_severity_ha") or {})
        )
        .call()
    )
    ...
    patch_count = (
        ...
        .validate()
        .set_task_instance_id("patch_count")
        .handle_errors()
        .with_tracing()
        .skipif(
            conditions=[
        ...
        .partial(geodataframe=burn_scar_result, **(params.get("patch_count") or {}))
        .call()
    )
    ...
    patch_count_fmt = (
        ...
        .validate()
        .set_task_instance_id("patch_count_fmt")
        .handle_errors()
        .with_tracing()
        .skipif(
            conditions=[
        ...
        .partial(count=patch_count, **(params.get("patch_count_fmt") or {}))
        .call()
    )
    ...
    widget_patches = (
        task(create_text_widget_single_view)
        .validate()
        .set_task_instance_id("widget_patches")
        .handle_errors()
        .with_tracing()
        .skipif(
            conditions=[
        ...
        .partial(
            title="Patches",
            data=patch_count_fmt,
            **(params.get("widget_patches") or {}),
        )
        .call()
    )
    ...
    detection_mode = (
        ...
        .validate()
        .set_task_instance_id("detection_mode")
        .handle_errors()
        .with_tracing()
        .skipif(
            conditions=[
        ...
        .partial(geodataframe=burn_scar_result, **(params.get("detection_mode") or {}))
        .call()
    )
    ...
    widget_mode = (
        task(create_text_widget_single_view)
        .validate()
        .set_task_instance_id("widget_mode")
        .handle_errors()
        .with_tracing()
        .skipif(
            conditions=[
        ...
        .partial(title="Mode", data=detection_mode, **(params.get("widget_mode") or {}))
        .call()
    )
    ...
    pre_scenes = (
        ...
        .partial(geodataframe=burn_scar_result, **(params.get("pre_scenes") or {}))
        .call()
    )
    ...
    post_scenes = (
        ...
        .partial(geodataframe=burn_scar_result, **(params.get("post_scenes") or {}))
        .call()
    )
